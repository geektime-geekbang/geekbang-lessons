...
//		System.out.println(StreamUtils.copyToString(fileSystemResource.getInputStream(), Charset.forName("UTF-8")));
		System.out.println(IOUtils.toString(fileSystemResource.getInputStream(), Charset.forName("UTF-8")));;
