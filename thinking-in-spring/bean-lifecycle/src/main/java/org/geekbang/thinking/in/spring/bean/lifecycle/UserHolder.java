...
public class UserHolder implements BeanNameAware, BeanClassLoaderAware, BeanFactoryAware, EnvironmentAware,
	...
	public void initPostConstruct() {
		...
		System.out.println("@PostConstruct is " + description);
	}
	...
	public void preDestroy() {
		...
		System.out.println("@PreDestroy is V10");
	}
	...
	public void destroy() throws Exception {
		...
		System.out.println("DisposableBean.destroy is V11");
	}

	public void doDestroy() {
		// destroy : The user holder V11
		this.description = "The user holder V12";
		System.out.println("destroy-method() is V12");
	}
	...
	public void afterSingletonsInstantiated() {
		...
		System.out.println("SmartInitializingSingleton.afterSingletonsInstantiated() is V8");
	}
